...
public class WebSocketConnectionTest {
  ...
  public void testOpen() throws Exception {
    ...
    when(client.sendRequest(eq("PUT"), eq("/api/v1/message"), null, any(Optional.class)))
    ...
    verify(client, times(3)).sendRequest(eq("PUT"), eq("/api/v1/message"), null, any(Optional.class));
  ...
  public void testOnlineSend() throws Exception {
    ...
    verify(client, times(2)).sendRequest(eq("PUT"), eq("/api/v1/message"), null, any(Optional.class));
